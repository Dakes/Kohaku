...
- The recipient SHALL be a literal address in this change; a user-account recipient SHALL be reserved for the change that creates accounts, and the database SHALL refuse a row naming both or neither.
